...
puntaje total obtenido. Puede que NO todas las N tareas formen parte de S debido a la restricción de caducidad.
        Por ejemplo, suponiendo las tareas
        T1 (P=10, C=2); T2 (P=20, C=1); T3 (P=8, C=2),
la secuencia óptima S sería [T2, T1] sumando 30 puntos (20 puntos de T2, 10 puntos de T1). La tarea T3 no forma parte de la secuencia porque su
...
public class Main {
    public static void main(String[] args) {
        Tarea t1 = new Tarea(1, 10); // C=2, P=10
        Tarea t2 = new Tarea(3, 20); // C=1, P=20
        Tarea t3 = new Tarea(2, 12);  // C=2, P=8

        GreedyParcial2024 greedy = new GreedyParcial2024();
        List<Tarea> secuencia = Arrays.asList(t1, t2, t3);


        System.out.println(greedy.solucionar(secuencia));
    }
