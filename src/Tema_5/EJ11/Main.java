...
import Tema_5.EJ2.Casilla;
import Tema_5.EJ2.Solucion;
...
// Fila 0
        ...
        matriz[0][1] = new Celda(0, false, true, true, false, 0, 1);
...
// Fila 1
        matriz[1][0] = new Celda(0, true, false, false, true, 1, 0);
        matriz[1][1] = new Celda(0, true, false, true, false, 1, 1);
        matriz[1][2] = new Celda(0, false, true, true, true, 1, 2);//ROBOT
...
// Fila 2
        ...
        matriz[2][2] = new Celda(0, false, true, true, false, 2, 2);
        ...
        BackTracking back = new BackTracking(matriz, fuenteDeCarga);
